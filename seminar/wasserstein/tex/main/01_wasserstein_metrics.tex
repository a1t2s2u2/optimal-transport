...
\begin{proof}
  $\varepsilon>0$ とする．$A,B$ の tightness より，
  \[
    \begin{gathered}
  ...
  $\pi\in\Couplings(A,B)$ を任意に取る．定義より
  \[
    \pi\in\Couplings(A,B)
    \iff
    \pi\in\bigcup_{\mu'\in A,\,\nu'\in B}\Couplings(\mu',\nu')
  \]
  だから，
  \[
    \mu\in A,\qquad
  ...
  \[
    \begin{aligned}
      ...
      &\leq
        ...
        +\pi\bigl(\mathcal{X}\times(\mathcal{Y}\setminus L_{\varepsilon/2})\bigr)\\
      &=\mu(\mathcal{X}\setminus K_{\varepsilon/2})
        +\nu(\mathcal{Y}\setminus L_{\varepsilon/2})\\
      &\leq\varepsilon.
    \end{aligned}
  \]
  $K_{\varepsilon/2}\times L_{\varepsilon/2}$ は compact であり，
  この評価は任意の $\pi\in\Couplings(A,B)$ に対して成り立つ．
  よって定義~\ref{def:meas-tight}より $\Couplings(A,B)$ は tight である．
\end{proof}
