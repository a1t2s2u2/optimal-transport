...
\begin{proof}
  ...
  \[
    \begin{gathered}
      ...
      \mu(\mathcal{X}\setminus K_{\varepsilon/2})
      \leq\frac{\varepsilon}{2}\quad(\forall\mu\in A),
      \qquad
      \nu(\mathcal{Y}\setminus L_{\varepsilon/2})
      \leq\frac{\varepsilon}{2}\quad(\forall\nu\in B)
    \end{gathered}
  \]
  となる $K_{\varepsilon/2},L_{\varepsilon/2}$ が存在する．

  $\pi\in\Couplings(A,B)$ を任意に取り，その第1，第2周辺分布を
  それぞれ $\mu,\nu$ とおく．すなわち
  \[
    \begin{aligned}
      \pi(E'\times\mathcal{Y})&=\mu(E')
      &&(\forall E'\in\Borel(\mathcal{X})),\\
      \pi(\mathcal{X}\times F')&=\nu(F')
      &&(\forall F'\in\Borel(\mathcal{Y}))
    \end{aligned}
  \]
  である．$\pi\in\Couplings(A,B)$ の定義より
  \[
    \mu\in A,\qquad \nu\in B.
  \]
  ここで
  \[
    E:=\mathcal{X}\setminus K_{\varepsilon/2}\in\Borel(\mathcal{X}),
    \qquad
    F:=\mathcal{Y}\setminus L_{\varepsilon/2}\in\Borel(\mathcal{Y})
  \]
  とおく．$\mu\in A,\nu\in B$ だから，$K_{\varepsilon/2},L_{\varepsilon/2}$
  の選び方より
  \[
    \mu(E)\leq\frac{\varepsilon}{2},
    \qquad
    \nu(F)\leq\frac{\varepsilon}{2}.
  \]

  $C_\varepsilon:=K_{\varepsilon/2}\times L_{\varepsilon/2}$ とおく．
  $K_{\varepsilon/2},L_{\varepsilon/2}$ は compact だから
  $C_\varepsilon$ も compact であり，
  \[
    (\mathcal{X}\times\mathcal{Y})\setminus C_\varepsilon
    =(E\times\mathcal{Y})\cup(\mathcal{X}\times F).
  \]
  したがって
  \[
    \begin{aligned}
      \pi\bigl((\mathcal{X}\times\mathcal{Y})\setminus C_\varepsilon\bigr)
      &=\pi\bigl((E\times\mathcal{Y})\cup(\mathcal{X}\times F)\bigr)\\
      &\leq\pi(E\times\mathcal{Y})+\pi(\mathcal{X}\times F)
      &&\text{（$\pi$ の劣加法性）}\\
      &=\mu(E)+\nu(F)
      &&\text{（$\mu,\nu$ は $\pi$ の周辺分布）}\\
  ...
  \]
  任意の $\varepsilon>0$ に対してこのような compact 集合 $C_\varepsilon$ が
  取れたので，定義~\ref{def:meas-tight}より
  $\Couplings(A,B)$ は tight である．
\end{proof}
